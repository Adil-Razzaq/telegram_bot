...
export const api = {
  ...
  prepareMinerBoost: () => apiCall('/miner/prepare-boost', { method: 'POST' }),
  activateMinerBoost: (nonce) => apiCall('/miner/boost', { method: 'POST', body: { nonce } }),
  ...
  extraAdTaskStatus: () => apiCall('/tasks/extra-ad-task/status'),
  prepareExtraAdTask: (slot) => apiCall('/tasks/extra-ad-task/prepare', { method: 'POST', body: { slot } }),
  claimExtraAdTask: (slot, nonce) => apiCall('/tasks/extra-ad-task/claim', { method: 'POST', body: { slot, nonce } }),
